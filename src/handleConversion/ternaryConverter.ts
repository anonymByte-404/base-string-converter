 ...
 */
export function ternaryConverter(inquirer: any, main: () => void): void {
  const startTernaryConversion = (): void => {
    inquirer
      .prompt([
        {
          type: 'list',
...
function ternaryToString(
  ...
  inquirer
    ...
    .then((answers: { ternaryInput: string }) => {
 ...
 */
function validateTernaryInput(input: string): boolean | string {
