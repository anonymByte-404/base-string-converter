  ...
  const promptTetradecimalInput = () => {
    inquirer
      ...
      .then((answers) => {
        ...
        // Validate if all inputs are valid tetradecimal numbers (0-9 and A-D for 10-13).
        ...
        // Convert tetradecimal numbers to text.
 ...
 *
 * Asks the user to provide tetradecimal data, validates it, and converts it into
 * the specified numeral system (e.g., Base 15, Base 16, etc.).
 */
  ...
  const promptTetradecimalInput = () => {
    inquirer
      ...
      .then((answers) => {
        ...
        // Convert tetradecimal numbers to the specified base.
        const result = tetradecimalArray
